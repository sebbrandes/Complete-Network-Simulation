...
- **Enable OSPF and specify network**
    ...
    LAN-DisSW-2(config-router)# `network 172.16.10.0 0.0.0.255 area 0`

    LAN-DisSW-2(config-router)# `network 172.16.20.0 0.0.0.255 area 0`

    LAN-DisSW-2(config-router)# `network 172.16.30.0 0.0.0.255 area 0`

    LAN-DisSW-2(config-router)# `network 172.16.40.0 0.0.0.255 area 0`

    LAN-DisSW-2(config-router)# `network 172.16.50.0 0.0.0.255 area 0`

    LAN-DisSW-2(config-router)# `network 172.16.100.0 0.0.0.127 area 0`
